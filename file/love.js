(function(window){
    ...
    Seed.prototype = {
        ...
        drawText: function() {
            ...
            ctx.fillText("Sorry Dear:) ", 30, -5);
            ctx.fillText("Click Here If you accept me !", 28, 10);
            ctx.restore();
        },
        clear: function() {
            var ctx = this.tree.ctx, cirle = this.cirle;
    ...
    Bloom = function(tree, point, figure, color, alpha, angle, scale, place, speed) {
        this.tree = tree;
        this.point = point;
        this.color = color || `rgb(${random(180,255)}, ${random(0,80)}, ${random(0,80)})`;
...
(function(window){
    ...
    Seed.prototype = {
        ...
        drawText: function() {
            ...
            ctx.scale(0.75, 0.75);
            ctx.font = "12px,Verdana"; // 字号肿么没有用? (ˉ(∞)ˉ)
            ctx.fillText("Sorry My Dear Jazuu :( ", 30, -5);
            ctx.fillText("Click on the heart if you accept my sorry ❤️", 28, 10);
            ctx.restore();
        },
        clear: function() {
            var ctx = this.tree.ctx, cirle = this.cirle;
